...
import { randomNumber, randomChars } from '../index.js'
...
function playerLengthProgress(snake) {
  ...
  if (snakeLength === 10) {
    console.log('You doing great! Keep going.')
  }
  else if (snakeLength === 20) {
    console.log(
      `Alredy ${snakeLength}! ${targetScore - snakeLength} left!`,
    )
  }
  else if (snakeLength === 30) {
    console.log(`You getting closer, ${targetScore - snakeLength} left!`)
  }
  else if (snakeLength === 40) {
    console.log(`Only ${targetScore - snakeLength} left! Cmon do it!`)
  }
  else if (snakeLength === 50) {
    process.exit()
    console.log(`You ate ${snakeLength} of 50 apples! Great You won!`)
  }
  else {
